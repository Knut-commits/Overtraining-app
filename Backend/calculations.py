def calculate_score(Heart_rate,sleep,Base_heart_rate):
    ...
    if Heart_rate - Base_heart_rate >= 5 and Heart_rate - Base_heart_rate < 10:
        Hr_score = 2
    if Heart_rate - Base_heart_rate >=10 and Heart_rate - Base_heart_rate < 15:
        Hr_score = 4
    if  Heart_rate - Base_heart_rate >=15 and Heart_rate - Base_heart_rate < 20:
        Hr_score = 6
    if Heart_rate - Base_heart_rate  >= 20 and Heart_rate - Base_heart_rate < 25:
        Hr_score = 8
